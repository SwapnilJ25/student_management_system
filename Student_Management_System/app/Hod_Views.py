...
def EDIT_STUDENT(request,id):
    ...
    course = Course.objects.all()
    session_year = Session_Year.objects.all()
    return render(request,'Hod/edit_student.html',{'student':student,'course':course,'session_year':session_year})
...
def DELETE_STAFF(request,admin):
    ...
    staff.delete()
    messages.success(request,"Staff deleted successdully")
    return redirect('view_staff')
